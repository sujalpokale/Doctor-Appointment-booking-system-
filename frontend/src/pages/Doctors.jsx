              ...
              <div className='p-4'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  {item.averageRating > 0 && (
                    <span className="text-sm bg-amber-50 text-amber-500 px-2 py-0.5 rounded-full flex items-center gap-1 font-semibold border border-amber-100">★ {item.averageRating}</span>
                  )}
                </div>
                <div className='flex items-center justify-between'>
                  <p className='text-[#5C5C5C] text-sm'>{item.speciality}</p>
                  {item.reviews && item.reviews.length > 0 && <p className='text-xs text-gray-400'>({item.reviews.length} reviews)</p>}
                </div>
              </div>
            </div>
          ))}
